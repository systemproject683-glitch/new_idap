        ...
        <div class="p-8">
            ...
            <div class="header-bar page-header-fixed">
                <div class="flex items-center justify-between h-full min-h-16">
                    <div>
                        <p class="text-gray-600 text-base">Chairperson / <span class="text-orange-600 font-semibold">Development Objectives - L&D Plan</span></p>
                    </div>
            ...
            <div class="px-5">
                ...
                <div class="card p-6 mb-6">
                    <form method="GET" action="{{ route('chairperson.development-objectives') }}">
                        <div class="flex flex-wrap gap-5 items-end">
                            ...
                            {{-- Department (locked to chairperson's dept) --}}
                            <div class="min-w-[200px]">
                                <label class="block text-sm font-medium text-gray-700 mb-1.5">Department</label>
                                <div class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm text-gray-500 bg-gray-50 flex items-center gap-2">
                    ...
                    <div class="card overflow-hidden">
                        ...
                        @if($facultyRecords->isEmpty())
                            <div class="py-16 text-center">
                                ...
                                <p class="text-gray-400 text-sm mt-1">No one in your department is enrolled in this objective.</p>
                            </div>
                        @else
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            @else
                                <a href="{{ $facultyRecords->previousPageUrl() }}"
                                   class="px-3 py-1.5 rounded-lg text-xs font-medium text-gray-600 bg-white border border-gray-200 hover:bg-gray-50 transition">Previous</a>
                            @endif

                            @foreach($facultyRecords->getUrlRange(1, $facultyRecords->lastPage()) as $pg => $url)
                                <a href="{{ $url }}"
                                   class="px-3 py-1.5 rounded-lg text-xs font-medium transition
                                          {{ $pg === $facultyRecords->currentPage() ? 'text-white bg-orange-500' : 'text-gray-600 bg-white border border-gray-200 hover:bg-gray-50' }}">
                                    {{ $pg }}
                                </a>
                            @endforeach
